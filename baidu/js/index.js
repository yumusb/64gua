 ...
 */
console.log("%c HTTPS://WIKI.I5.GS/", "font-size:30pt;color:red;align:center;");console.log("%c更多精彩请访问以上站点", "font-size:10pt;color:red;align:center;");
// 剪切板功能模块
...
$("#search-button").click(function() {
    ...
    query_text = base64.encode(encodeURIComponent(input_text));
    url = hostname + "?q=" + query_text;
    console.log("更多API尽在:wiki.i5.gs!!");
    $.ajax({url:"https://vip.video.qq.com/fcgi-bin/comm_cgi?name=short_url&need_short_url=1&url="+url,dataType:"jsonp",jsonp: "callback",success:function(data){shorturl = data.short_url;document.getElementById("tip-input").value=shorturl;}});
});
// 主要业务逻辑
$(document).ready(function() {
    ...
    query = decodeURIComponent(base64.decode(query)); // 对查询的内容进行URL解码
